...
var botdb = process.env.INSTANCE == 'TEST' ? cloudant.db.use('botdb') : cloudant.db.use('devbotdb');
var chatlog = process.env.INSTANCE == 'TEST' ? cloudant.db.use('chatlog') : cloudant.db.use('devchatlog');
